...
async function main() {
  ...
  const url = params.get("url") ? new URL(params.get("url"), "https://mimnsi.github.io/interactive_scenes_3d_estate_2/demo/assets/data/4dgsflame/") : "flame.splatv";
